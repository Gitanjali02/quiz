...
const dbscoresubmit = document.getElementById("dbsubmit");
...
dbscoresubmit.addEventListener("click", dbScore);
...
function startGame() {
  ...
  dbscoresubmit.classList.add("hide");
...
function gameOver() {
  ...
  dbscoresubmit.classList.remove("hide");
  timer = 90;
  score = 0;
}
